...
// Variables
const rootDomain = "alfarizi17062004.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "alfa-cloud"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>V2RAY-VVIP</span>");
